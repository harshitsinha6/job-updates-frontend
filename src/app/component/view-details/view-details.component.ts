...
export class ViewDetailsComponent implements OnInit {
  ...
  getDataWithoutFilter(){
    this.my_data = [];
    this.currentPageData = [];
    this.service.getData(this.currentPageNumber, this.currentPageSize).subscribe(data => {
      for(let x of data){
        // jd: new JobDetails();
        ...
        this.available_company_name.push(x['companyName']);
  ...
  getDataWithFilter(){
    ...
    if(this.selected_company !== "" && this.selected_job_type.length > 0 && this.selected_location.length > 0 && this.selected_status.length > 0){
      this.service.getFilteredDataForNameStatusLocationJobType(this.selected_company, 
        this.selected_status, this.selected_location, this.selected_job_type, this.currentPageNumber, this.currentPageSize).subscribe(data => {
          for(let x of data){
            var jobDetailsObject = this.getMappedData(x);
            this.my_data.push(jobDetailsObject);
            if(this.currentPageData.length < this.pageSize){
              this.currentPageData.push(jobDetailsObject);
            }
      ...
      this.service.getFilteredDataForNameStatusLocation(this.selected_company, this.selected_status, 
        this.selected_location, this.currentPageNumber, this.currentPageSize).subscribe(data => {
          for(let x of data){
            var jobDetailsObject = this.getMappedData(x);
            this.my_data.push(jobDetailsObject);
            if(this.currentPageData.length < this.pageSize){
      ...
      this.service.getFilteredDataForNameStatusJobType(this.selected_company, this.selected_status, 
        this.selected_job_type, this.currentPageNumber, this.currentPageSize).subscribe(data => {
          for(let x of data){
            var jobDetailsObject = this.getMappedData(x);
            this.my_data.push(jobDetailsObject);
            if(this.currentPageData.length < this.pageSize){
      ...
      this.service.getFilteredDataForNameLocationJobType(this.selected_company, this.selected_location, 
        this.selected_job_type, this.currentPageNumber, this.currentPageSize).subscribe(data => {
          for(let x of data){
            var jobDetailsObject = this.getMappedData(x);
            this.my_data.push(jobDetailsObject);
      ...
      this.service.getFilteredDataForStatusLocationJobType(this.selected_status, this.selected_location, 
        this.selected_job_type, this.currentPageNumber, this.currentPageSize).subscribe(data => {
          for(let x of data){
            var jobDetailsObject = this.getMappedData(x);
            this.my_data.push(jobDetailsObject);
      ...
      this.service.getFilteredDataForNameStatus(this.selected_company, this.selected_status, this.currentPageNumber, this.currentPageSize).subscribe(data => {
        for(let x of data){
          var jobDetailsObject = this.getMappedData(x);
          this.my_data.push(jobDetailsObject);
          if(this.currentPageData.length < this.pageSize){
      ...
      this.service.getFilteredDataForLocationJobType(this.selected_location, this.selected_job_type, this.currentPageNumber, this.currentPageSize).subscribe(data => {
        for(let x of data){
          var jobDetailsObject = this.getMappedData(x);
          this.my_data.push(jobDetailsObject);
          if(this.currentPageData.length < this.pageSize){
      ...
      this.service.getFilteredDataForNameJobType(this.selected_company, this.selected_job_type, this.currentPageNumber, this.currentPageSize).subscribe(data => {
        for(let x of data){
          var jobDetailsObject = this.getMappedData(x);
          this.my_data.push(jobDetailsObject);
          if(this.currentPageData.length < this.pageSize){
      ...
      this.service.getFilteredDataForNameLocation(this.selected_company, this.selected_location, this.currentPageNumber, this.currentPageSize).subscribe(data => {
        for(let x of data){
          var jobDetailsObject = this.getMappedData(x);
          this.my_data.push(jobDetailsObject);
          if(this.currentPageData.length < this.pageSize){
      ...
      this.service.getFilteredDataForStatusJobType(this.selected_status, this.selected_job_type, this.currentPageNumber, this.currentPageSize).subscribe(data => {
        for(let x of data){
          var jobDetailsObject = this.getMappedData(x);
          this.my_data.push(jobDetailsObject);
          if(this.currentPageData.length < this.pageSize){
      ...
      this.service.getFilteredDataForStatusLocation(this.selected_status, this.selected_location, this.currentPageNumber, this.currentPageSize).subscribe(data => {
        for(let x of data){
          var jobDetailsObject = this.getMappedData(x);
          this.my_data.push(jobDetailsObject);
          if(this.currentPageData.length < this.pageSize){
      ...
      this.service.getFilteredDataForName(this.selected_company, this.currentPageNumber, this.currentPageSize).subscribe(data => {
        for(let x of data){
          var jobDetailsObject = this.getMappedData(x);
          this.my_data.push(jobDetailsObject);
          if(this.currentPageData.length < this.pageSize){
      ...
      this.service.getFilteredDataForStatus(this.selected_status, this.currentPageNumber, this.currentPageSize).subscribe(data => {
        for(let x of data){
          var jobDetailsObject = this.getMappedData(x);
          this.my_data.push(jobDetailsObject);
          if(this.currentPageData.length < this.pageSize){
      ...
      this.service.getFilteredDataForLocation(this.selected_location, this.currentPageNumber, this.currentPageSize).subscribe(data => {
        for(let x of data){
          var jobDetailsObject = this.getMappedData(x);
          this.my_data.push(jobDetailsObject);
          if(this.currentPageData.length < this.pageSize){
      ...
      this.service.getFilteredDataForJobType(this.selected_job_type, this.currentPageNumber, this.currentPageSize).subscribe(data => {
        for(let x of data){
          var jobDetailsObject = this.getMappedData(x);
          this.my_data.push(jobDetailsObject);
          if(this.currentPageData.length < this.pageSize){
